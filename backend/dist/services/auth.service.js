...
const promoteConfiguredAdmin = async (user) => {
...
export const googleAuthService = async (idToken) => {
    ...
    if (!user)
        throw new Error('Unable to create or load Google account');
...
export const login = async (identifierInput, pass) => {
...
export const sendOTPService = async (phoneInput) => {
...
export const verifyOTPService = async (phoneInput, code) => {
    const phone = sanitizePhone(phoneInput);
