...
const MEMBERSHIP_BOOST = {
    STAR: 1.0,
    PREMIUM: 0.8,
    STANDARD: 0.4,
    BASIC: 0.0,
};
export const discoverBuddies = async (userId, filters, tab, page, limit) => {
    ...
    if (tab === 'for-you' || tab === 'near-you') {
        ...
        const currentInterestSlugs = new Set(currentUser?.interests.map((i) => i.interest.slug) || []);
        // Score each buddy
