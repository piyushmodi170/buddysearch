/**
 * Browser traffic must stay on the page origin. Next rewrites proxy /api
 * and /socket.io to Express. Pointing the client at localhost:4000 hangs
 * in cloud previews because that port is not the page the user opened.
 */
