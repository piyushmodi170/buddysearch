...
import { SiteContact } from '@/components/seo/EeatBits';
  ...
  return (
    <div className="min-h-screen bg-[#F9EFEF] text-[#3D4550]">
      <header className="bg-white border-b border-[#f0e0e0]">
        <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="flex gap-4 text-sm font-medium">
            ...
            <Link href="/contact" className="hover:text-[#F96566]">Contact</Link>
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <footer className="pt-10 mt-10 border-t border-[#f0e0e0]">
          <SiteContact />
        </footer>
      </main>
    </div>
