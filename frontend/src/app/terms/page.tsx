    ...
    <>
      ...
      <PublicDoc title="Terms of Service">
        ...
        <p className="aeo-direct text-lg font-medium">
          Buddy Search is a platform for platonic, activity-based companionship. You hire a Buddy for a named plan,
          or you offer time as a Buddy. Dating, sexual services, fake relationships, harassment, and illegal work are
          banned. Membership pays for platform access. Activity fees are agreed between you and the other member in
          chat.
        </p>
