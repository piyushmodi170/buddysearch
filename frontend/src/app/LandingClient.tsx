        ...
        <div className="container">
          ...
          <div className="footer__bottom">
            ...
            <div className="footer__legal-links">
              <Link className="footer__legal-link" href="/terms">Terms</Link>
              <span className="footer__legal-sep">·</span>
              <Link className="footer__legal-link" href="/privacy">Privacy</Link>
              <span className="footer__legal-sep">·</span>
              <Link className="footer__legal-link" href="/privacy">Cookies</Link>
            </div>
          </div>
        </div>
      </footer>
